    ...
    <div className="tasks-modal-overlay" role="dialog" aria-modal="true" aria-label="Confirmar exclusão">
      <div className="tasks-confirm-modal">
        ...
        <div className="tasks-confirm-modal__actions">
          <Button
            variant="ghost"
            className="tasks-confirm-modal__btn-cancel hover:bg-white/10"
            onClick={onCancel}
            disabled={isDeleting}
          >
            Cancelar
          ...
          <Button
            className="tasks-confirm-modal__btn-delete hover:bg-red-600 active:bg-red-700 focus-visible:ring-2 focus-visible:ring-red-500"
            onClick={onConfirm}
            disabled={isDeleting}
          >
...
export function TasksPage() {
  ...
  return (
    <div className="tasks-layout">
      ...
      <div className="tasks-main">
        ...
        <header className="tasks-topbar">
          <div className="tasks-topbar__search">
            ...
            <input className="tasks-topbar__search-input" placeholder="Buscar tarefas..." value={search} onChange={(e) => { setSearch(e.target.value); setCurrentPage(1) }} aria-label="Buscar tarefas" />
          </div>
      ...
      {/* Modal nova tarefa */}
      {showNewModal && <NewTaskModal onClose={() => setShowNewModal(false)} onSubmit={addTask} />}
